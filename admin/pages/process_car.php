    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["car_image"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO cars (
                vehicle_name, brand, vehicle_type, fuel_tank_capacity, rear_tread, gross_weight, width, wheel_base, turning_radius, seating_capacity,
            ...
            if ($conn->query($sql) === TRUE) {
                echo json_encode(["status" => "success", "message" => "New car added successfully"]);
            } else {
