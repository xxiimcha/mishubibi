                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-item img-hover_effect">
                            <div style="background-image: url('images/homepage.jpg'); background-repeat: no-repeat; background-position: center center; background-size: cover; min-height: 435px;"></div>
                        </div>
                    </div>
                </div>
            </div>
